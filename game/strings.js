...
export const STR = {
  ...
  shop: { title: "BUY MENU", close: "CLOSE (B)", free: "FREE", sell: "SELL", eco: "ECO PISTOL",
    hint: "Buy with credits · earn 200 per kill · tap your weapon or SELL to refund · ECO = cheap pistol" },
  ...
  online: {
    ...
    hello: "Welcome, {name}",
    change: "change",
    friendAdded: "Added {name}!",
    friendNotFound: "No player found with that name",
    friendSelf: "That's you 🙂",
    rankedLocked: "Reach level 20 to unlock Ranked",
